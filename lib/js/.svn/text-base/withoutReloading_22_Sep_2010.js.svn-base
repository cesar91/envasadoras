		...
		ajax.onreadystatechange=function() 		
		 {
			   if (ajax.readyState==1 || ajax.readyState==2 || ajax.readyState==3)
			   {
                ...
                { 
					...
					document.getElementById("divIva").innerHTML='$<input type="text" name="iva" id="iva" value="'+arrDatos[2]+'" style="width:45px" onkeypress="return validaNum (event); activaSave()" onkeyup="activaSave()" />MXP';
					
					document.getElementById("divTua").innerHTML='<input type="text" name="tua" id="tua" value="'+arrDatos[3]+'" style="width:45px" onkeypress="return validaNum (event); activaSave()" onkeyup="activaSave()" />MXP';
...
function searchSolicitud(){
	...
	ajax.onreadystatechange=function() {
       ...
       { 	
			...
			$("#divTotalItinerarioC"+x).html("Total en Conceptos: $" +number_format(arrDatos[i],2,".",","));
