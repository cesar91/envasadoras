...
//Inserta o actuliza en Catalogo Gral
	...
	if($vb=="Agregar"){
		...
		$obCat->Add($concepto, $cuenta, $clasificacion,1);
	}
...
<body>
<?php
$I  = new Interfaz("Catalogos",true);

// Deshabilitamos los otros catalogos en Marti
//require_once("menu.php");

if (isset($_GET['catalogo']) && $_GET['catalogo']=="cg")
	require_once("cat_gral.php");

else if (isset($_GET['catalogo']) && $_GET['catalogo']=="cz")
