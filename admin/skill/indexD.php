...
if(isset($_GET['action']) && $_GET['action']=="cancel" &&  isset($_GET['id']) && $_GET['id']!=""){
	...
	$cad="Estimado <strong>".$U->Get_dato_Empleado('nombre')."</strong>  el usuario <strong> {$_SESSION["usuario"]}</strong> ha rechazado la delegación que le solicito.";
...
// 	});
	...
	function validatorForm(){
		...
		if($("#email").val()!= "" && $("#telefono").val()!="" && $("#jefe").val()!=""){
...
<table width="400" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#f5f5f5">
    ...
    <tr>
    	<td class="formlabel"><div align="right">Correo electr&oacute;nico<span class="style1">*</span>: </div></td>
        <td>
			<input name="email" type="text" class="SrcInput" id="email" value="<?php echo $Usu->Get_dato('u_email'); ?>">
		</td>
    </tr>
    <tr>
    	<td class="formlabel"><div align="right">Tel&eacute;fono<span class="style1">*</span>:</div></td>
        <td>
			<input name="telefono" type="text" class="SrcInput" id="telefono" value="<?php if($rowsEmpleado>0) echo $Usu->Get_dato_Empleado('telefono'); ?>" onKeyPress="return validaNum(event);">
		</td>
    </tr>
    <tr>
		<td>&nbsp;</td>
	...
	<tr>
    	<td class="formlabel" colspan="2">
			...
			<div class="fader" align="right">
				...
				Nueva Contrase&ntilde;a<span class="style1">*</span>:
    			<input name="passwd" type="password" id="passwd" >
				&nbsp;&nbsp;&nbsp;&nbsp;		
				<br>
				<br>
				Repetir contrase&ntilde;a<span class="style1">*</span>:
				<input name="passwd2" type="password" class="SrcInput" id="passwd2" style="width:130">
				&nbsp;&nbsp;&nbsp;&nbsp;								
    ...
    <tr>
    	<td colspan="2"><div class="txtBluAr9" align="center">Los campos con <span class="style1">*</span> son obligatorios </div></td>       
       </tr>
</table>
</td>
	...
	<tr>
    	<td colspan="2" class="formlabel">
			...
			<div class="fader" align="right">
				...
				<?php				
					if($rowsEmpleado==0 || $Usu->Get_dato_Empleado('delegado')==0 || $Usu->Get_dato_Empleado('delegado')==""){ 
				?>
						<script type="text/javascript">
							checa(1);
						</script>
					...
					?>
						<script type="text/javascript">
							checa(2,<?php echo $Usu->Get_dato_Empleado('delegado');?>);
						</script>
					<?php
