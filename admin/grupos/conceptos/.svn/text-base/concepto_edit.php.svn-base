...
error_log(print_r($_POST, True));
	...
	function Actualizar(){
			      ...
			      isset($_POST['dc_id']) && $_POST['dc_id']!="")
		{
            ...
            $concepto->Edita_Concepto($dc_id, $dc_catalogo,$cp_clasificacion,$cp_concepto,$cp_cuenta,$cp_empresa_id,$cp_estatus);
		...
		<form name="form1" method="post"/>
			<table width="80%" align="center" cellpadding="4" cellspacing="4" border="0" bgcolor="#f4f4f4" style="padding-top: 20px;">
                ...
                <tr>
				 ...
				 <tr>
                    <td align="right" width="30%"><input type="hidden" name="catalogo" id="catalogo" size="70" value="<?php echo $concepto->Get_dato("dc_catalogo");?>"/></td>
                </tr>
				 <tr>
				 	...
				 	<td align="right" width="30%">Clasificaci&oacute;n :</td>
                        <td>
                            <select name='clasificacion'>
                                <?php if($concepto->Get_dato("cp_clasificacion")=="DEDUCIBLE") { ?>
                                    <option selected='selected' value='DEDUCIBLE'>DEDUCIBLE</option>
                                    <option value='NO DEDUCIBLE'>NO DEDUCIBLE</option>                                
                                <?php } else { ?>
                                    <option value='DEDUCIBLE'>DEDUCIBLE</option>
                                    <option selected='selected' value='NO DEDUCIBLE'>NO DEDUCIBLE</option>                                   
                                <?php } ?>
                            </select>
                        </td>
				</tr>
				 ...
				 <tr>
                    ...
                    <td> <select name='empresa_id'>
                        <?php 
                            $cc_empresa_id = $concepto->Get_dato("cp_empresa_id");                        
