...
class Comprobacion extends conexion {
	...
	public function Crea_Comprobacion_Invitacion2($total, $sol_inv, $co_subtotal, $co_iva, $tramite, $centroCosto, $cMotive, $cTipo, $observ, $observEdicion, $tot_invitados, $invitacionLug, $fecha_inv, $excedente, $co_ciudad, $co_amex_comprobado, $co_efectivo_comprobado){
		$query = sprintf(
	...
	public function edita_Comprobacion_Invitacion2($total, $sol_inv, $co_subtotal, $co_iva, $centroCosto, $cMotive, $cTipo, $observ, $observEdicion, $tot_invitados, $invitacionLug, $fecha_inv, $excedente, $co_ciudad, $co_amex_comprobado, $co_efectivo_comprobado, $tramite){
	...
	*/
	...
	function ActualizarResumenFinanzas($idTramite,$anticipoCABMW,$personalDescuento,$amexCABMW,$efectivoCXBMW,$montoDescontar,$montoReembolsar,$amexExterno,$totalComp){
		$aux=array();
	...
	function ActualizarCamposAprobados($idtramitefin, $tipo, $notransaccion, $fecha, $comentario, $monto, $propina, $iva, $imphospedaje, $total, $divisa, $conceptoP, $detalleProcedente, $idcargoAmex){
		...
		*/
		...
		$queryco_id = sprintf("SELECT co_id 
								FROM comprobaciones 
								WHERE co_mi_tramite =%s",$idtramitefin);
		$conceptoTemp = parent::consultar($queryco_id);
		$fila = mysql_fetch_assoc($conceptoTemp);
		$co_id = $fila['co_id'];
		/*
		$queryInsert="INSERT INTO detalle_comprobacion(
			dc_comprobacion,
			dc_tipo,
			dc_idamex_comprobado,
			dc_notransaccion,
		...
		$sql = "INSERT INTO detalle_comprobacion
                    ...
                    VALUES
					(DEFAULT, '$co_id', '$tipo', '$dc_notransaccion', '$dc_idamex_comprobado', NOW(), 
					'$conceptoP', '0', '$comentario', '0', '$date_db', '0', '0',
					'0', '$monto', '$iva', '0', '$propina', '$imphospedaje', '$total',
					'$divisa', '0', '$total', '0', '0', '$detalleProcedente',
					'0', '0', '0')";
					parent::insertar($sql);
