...
class ConexionERP {
	...
	public function Registra_Anticipo($anticipo){
        ...
        $data['PREPAID_AUTO_APPLY'] = 'N';                  // Este debe ser N en el anticipo, para efecto de que se contabilice de acuerdo a lo que creemos Roberto y yo.
	...
	public function Registra_Comprobacion($comprobacion){
        ...
        $data['MATCH_ACTION'] = 'Y';                                        // Valor por defecto
        $data['PREPAID_AUTO_APPLY'] = 'Y';                                  // Debe ser Y para la comprobacion, creemos Roberto y yo para que se pueda aplicar la comprobacion automatica
        $data['IN_PROCESS_FLG'] = 'N';                                      // Valor por defecto
