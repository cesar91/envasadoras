...
else if(isset($_POST["autorizar"]))
{
    ...
    for ($i = 0; $i < $no_conceptos; $i++) {
       ...
       if ($dc_id!=""){
          //error_log(sprintf("APRUEBA: concepto-%s = %s", $i, $dc_id));
...
<table border="0" align="center">
       <tr>
           <td colspan="5" align="center">
              <div id="centroDefault"><b>Centro de Costos al que se cargar&aacute; el monto:&nbsp;<br><?php echo "$cc_centrocostos - $cc_nombre";?></b></div>
           </td>
       </tr>
       <tr>
       </tr>
