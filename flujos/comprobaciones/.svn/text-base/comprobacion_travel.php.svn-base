...
?>
	...
	<script type="text/javascript">
		...
		j('#comprobacion_table tr td:nth-child(11)').show();
		var id = 0;
j(document).ready(function(){
	ocultarElemento("tr_kilometraje");
		...
		j('#CargaArchivo').click(function(event){
			  ...
			  j('html').append('<iframe style="" id="myiframe" name="myiframe" src=""></iframe>');
			  j("#cargaXML").submit();
			  $("#myiframe").load(function(e){
			   ...
			   alert("Error de conexion");
				...
				j("#concepto").val(0);
				j("#concepto").trigger("change");			   
				console.log("error del catch"+ex);
			   } 
			   $.unblockUI();        
			   $(this).remove();
			   e.preventDefault();
	...
	<div style="display:none" id="tablaXML">
		...
		<center><h2>Comprobaci&oacute;n de Viaje</h2></center>
