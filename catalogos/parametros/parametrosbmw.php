<div align="center">
	<h1>Configuraci&oacute;n de Par&aacute;metros</h1>
	<form name="addConcepto" id="addConcepto" action="index.php?catalogo=cg" method="post">
		<table style="background:#F8F8F8">
			<tr>
				...
				<td><input type="text" size=50  disabled name="name_parameter" id="name_parameter" readonly="readonly"/></td>
				<td>Valor par&aacute;metro<span class="style1">*</span>:</td>
				<td><input type="text" name="valor_parametro" id="valor_parametro" style="width:90px" onkeypress="return validaNum(event)"/></td>
			</tr>
			<tr>
				<td>Regi&oacute;n<span class="style1">*</span>: </td>
				<td><input type="text" disabled size=40 name="name_region" id="name_region" readonly="readonly"/></td>
				<td>Divisa<span class="style1">*</span>:</td>
				<td><input type="text" name="divisa" id="divisa" style="width:90px" disabled="true" onkeypress="return validaNum(event)"/></td>
			</tr>
			<tr>
				<td colspan="4">&nbsp;</td>
			</tr>
