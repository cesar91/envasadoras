...
<center><h3>Reporte de Gastos AMEX</h3></center>
<FORM ACTION="reporte_de_gastos_amex.php" METHOD="post" >
...
if(isset ($_POST['buscar']) && isset($_POST['fechaInicio']) && $_POST['fechaInicio']!="" && isset($_POST['fechaFin']) && $_POST['fechaFin']!=""){
	...
	$_SESSION['nombre'] = "reporteGastosAMEX";
	$_SESSION['head'] = "REPORTE GASTOS AMEX";
	$_SESSION['aux2'] = $aux2;
    ...
    $aux.="<td style=\"font-size: 12px;\"><br><br><strong>FECHA COMPROBACIÓN</strong></td>";
    $aux.="<td style=\"font-size: 12px;\"><br><br><strong>NÚMERO DE COMPROBACIÓN</strong></td>";
	...
	foreach ($array as $row){
		...
		$aux.="<td style=\"font-size: 10px;\" align='left'>{$row['FECHA COMPROBACION']}</td>";
		$aux.="<td style=\"font-size: 10px;\" align='left'>{$row['NUMERO DE COMPROBACION']}</td>";
		$aux.="</tr>";
	}
