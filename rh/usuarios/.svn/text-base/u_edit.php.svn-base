		...
		<table width="80%" align="center" cellpadding="4" cellspacing="4" border="0" bgcolor="#f4f4f4" style="padding-top: 20px;">
								...
								<tr>
									...
									<?php
										...
										for ($tmp2=0;$tmp2<count($arregloGuardados);$tmp2++){											
											//error_log($arregloGuardados[$tmp2]['ut_tipo']."->".$arrTiposUsuario[$indicTiposUsuario2][0]);
			...
			<tr>
				...
				<tr>
				   ...
				   <td><input type="text" name="cuentaporcobrar" id="cuentaporcobrar" size="40"  onkeypress="return validaNum(event);" value="<?php echo $Usu->Get_dato("u_producto");?>"  /></td>
				 </tr>
